  ...
  return (
    <section className="bg-violet-50 p-3 rounded-lg m-4">
      <div className="flex flex-col justify-center items-center">
        ...
        <p className="text-2xl text-violet-500 font-medium mb-2">
        ...
        <div className="flex flex-col justify-center items-center mt-5">
          <a
            ...
            className="rounded-lg border bg-violet-500 py-2.5 px-5 text-white text-lg cursor-pointer font-medium mb-4 mt-3 hover:bg-violet-600 active:shadow-md active:translate-y-2"
          >
            Download CV
          </a>
        </div>
